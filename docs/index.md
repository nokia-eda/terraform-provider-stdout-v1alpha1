---
page_title: "stdout-v1alpha1 Provider"
---

# stdout-v1alpha1 Provider

This provider is used to interact with the resources provided by the **stdout-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
