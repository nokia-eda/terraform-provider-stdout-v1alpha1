...
package datasource_cluster_standard_out_list
...
func ClusterStandardOutListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterStandardOutListModel struct {
