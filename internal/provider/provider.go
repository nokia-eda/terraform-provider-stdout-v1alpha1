...
var _ provider.Provider = (*stdoutProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &stdoutProvider{version: ver}
	}
}
...
func (p *stdoutProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *stdoutProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *stdoutProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "stdout-v1alpha1"
	resp.Version = p.version
}

func (p *stdoutProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterStandardOutDataSource,
		NewClusterStandardOutListDataSource,
		NewResourceListDataSource,
		NewStandardOutDataSource,
		NewStandardOutListDataSource,
	}
}

func (p *stdoutProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterStandardOutResource,
		NewStandardOutResource,
	}
}
