...
package resource_cluster_standard_out
...
func ClusterStandardOutResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^stdout\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("stdout.eda.nokia.com/v1alpha1"),
			},
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterStandardOut$"), ""),
				},
				Default: stringdefault.StaticString("ClusterStandardOut"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ClusterStandardOut",
				MarkdownDescription: "name of the ClusterStandardOut",
			},
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"exports": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"fields": schema.ListAttribute{
									ElementType:         types.StringType,
									Optional:            true,
									Description:         "List of fields to be exported from the EDB table, defaults to all if omitted.",
									MarkdownDescription: "List of fields to be exported from the EDB table, defaults to all if omitted.",
								},
								...
								"path": schema.StringAttribute{
									Required:            true,
									Description:         "The EDB path to the table being exported, formatted as '.namespace.node.srl.interface'.\nStandardOut exports are restricted to its own namespace.\nClusterStandardOut exports can export data from multiple namespaces as well as cluster tables.",
									MarkdownDescription: "The EDB path to the table being exported, formatted as '.namespace.node.srl.interface'.\nStandardOut exports are restricted to its own namespace.\nClusterStandardOut exports can export data from multiple namespaces as well as cluster tables.",
								},
								"period": schema.StringAttribute{
									Optional:            true,
									Computed:            true,
									Description:         "Export period, in the format 10s , 1m30s , 1h30m etc.",
									MarkdownDescription: "Export period, in the format 10s , 1m30s , 1h30m etc.",
									Default:             stringdefault.StaticString("10s"),
								},
								"where": schema.StringAttribute{
									Optional:            true,
									Description:         "A where clause to use for the query, e.g. oper-state = down . Enclosing parentheses can be omitted.",
									MarkdownDescription: "A where clause to use for the query, e.g. oper-state = down . Enclosing parentheses can be omitted.",
								},
							},
						...
						Required:            true,
						Description:         "Exports is the list of EDB paths to be exported and mode for each.",
						MarkdownDescription: "Exports is the list of EDB paths to be exported and mode for each.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				Required:            true,
				Description:         "ClusterStandardOutSpec defines the desired state of ClusterStandardOut.",
				MarkdownDescription: "ClusterStandardOutSpec defines the desired state of ClusterStandardOut.",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "ClusterStandardOutStatus defines the observed state of ClusterStandardOut.",
				MarkdownDescription: "ClusterStandardOutStatus defines the observed state of ClusterStandardOut.",
			},
		},
	}
}

type ClusterStandardOutModel struct {
